...
const Header = ({ user }) => {
  ...
  return (
    <>
      {/* make full width 1 line info with close btn */}
      ...
      <header id='header' className='fixed-top'>
        <div className='container d-flex align-items-center justify-content-between'>
          <h1 className='logo '>
            <a href='/'>{process.env.SITE_NAME}</a>
          </h1>
          ...
          {user ? (
            <div className='dropdown text-center'>
              ...
              <ul className='dropdown-menu text-small'>
                ...
                <li>
                  <Link className='dropdown-item' href='/visuals'>
                    My Tree
                  </Link>
                </li>
                <li>
                  <hr className='dropdown-divider divider-light' />
                </li>
                <li>
                  <button className='dropdown-item btn-transparent btn-hover-gray' onClick={handleLogout}>
                    Sign out
                  </button>
                </li>
              </ul>
