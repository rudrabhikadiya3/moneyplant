...
const dashboard = ({ user, pkgtypes }) => {
  ...
  const ed =
    new Date(moment(moment(endDate).format("MM/DD/YYYY")).add(23, "h").add(59, "m").add(59, "s")).getTime() / 1000;
  ...
  return (
    <>
      <div className='cotainer-fluid pageHeading'>
          ...
          <div className='col-12 mb-4'>
            <div className='border box-card'>
              <Tabs
                ...
                className='border-bottom justify-content-center justify-content-md-start'>
                <Tab
                ...
                <Tab
                  ...
                  <div className='d-flex align-items-center p-3 my-3 col-12 col-md-6 flex-wrap'>
                    ...
                    <div className='col-12 col-md-3 align-self-end px-2 mb-3 mb-md-0'>
                      <button
                        className='btn btn-primary align-self-end col-12'
                        onClick={getPkgHistry}
                        disabled={pkgDataLoader}>
                        Search
                      </button>
                    </div>
                  </div>
                      ...
                      <thead>
                        <tr>
                          <th className='sort-cell' onClick={() => sorting(0, order == -1 ? 1 : -1)}>
                            #{" "}
                            <i
                              className={`bi ${orderColumn === 0 ? (order == -1 ? "bi-caret-up-fill" : "bi-caret-down-fill") : ""
                                }`}
                            />
                          </th>
                          <th className='sort-cell' onClick={() => sorting(1, order == -1 ? 1 : -1)}>
                            Package{" "}
                            <i
                              className={`bi ${orderColumn === 1 ? (order == -1 ? "bi-caret-up-fill" : "bi-caret-down-fill") : ""
                                }`}
                            />
                          </th>
                          <th className='sort-cell' onClick={() => sorting(2, order == -1 ? 1 : -1)}>
                            Amount{" "}
                            <i
                              className={`bi ${orderColumn === 2 ? (order == -1 ? "bi-caret-up-fill" : "bi-caret-down-fill") : ""
                                }`}
                            />
                          </th>
                          <th className='sort-cell' onClick={() => sorting(3, order == -1 ? 1 : -1)}>
                            Purachased At{" "}
                            <i
                              className={`bi ${orderColumn === 3 ? (order == -1 ? "bi-caret-up-fill" : "bi-caret-down-fill") : ""
                                }`}
                            />
                          </th>
                        </tr>
          ...
          <div className='col-12'>
            <div className='box-card border p-3'>
              {chartData.length ? (
                ...
                <>
                  <h4 className='text-center text-dark'>You haven't earn any reaward yet</h4>
                  <p className='text-center'>
                    Refer friends, when they buy one of our packages, EARN REWARDS and your earning's chart will appear
                    here{" "}
                  </p>
                </>
              )}
