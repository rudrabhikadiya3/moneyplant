      ...
      case 0:
        return (
          <>
            ...
            <li className="na"><i className="bx bx-x" /><span>Nulla at volutpat diam uteera</span></li>
            <li className="na">
              <i className="bx bx-x" /><span>Pharetra massa massa ultricies</span>
            </li>
            <li className="na">
              <i className="bx bx-x" /><span>Massa ultricies mi quis hendrerit</span>
            </li>
          </>
        );
      case 1:
          ...
          <div className="container" data-aos="fade-up">
            ...
            <div className="row content">
              <div className="col-lg-6">
                ...
                <ul>
                  <li>
                    <i className="ri-check-double-line" /> Ullamco laboris nisi ut aliquip ex ea commodo
                    consequat
                  </li>
                  <li>
                ...
                pkgData.map((d, i) => {
                  return (
                    <div className="col-lg-3 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay={100} key={i}>
                      <div className="box">
                        <h3>{d.name}</h3>
                        <h4><sup>$</sup>{d.price}</h4>
                        <ul>{getFeatures(i)}</ul>
                        <button className="btn btn-login fw-bold" onClick={() => buyPackage({ pckgid: d._id, name: d.name, amount: d.price })}>Buy Now</button>
                      </div>
                    </div>
                  )
                })
            ...
            <div className="row">
              <div className="col-lg-7 d-flex flex-column justify-content-center align-items-stretch order-2 order-lg-1">
                ...
                <div className="accordion-list">
                  <ul>
                    <li>
                      <a data-bs-toggle="collapse" className="collapse" data-bs-target="#accordion-list-1"><span>01</span> Non consectetur a erat nam at lectus urna duis?
